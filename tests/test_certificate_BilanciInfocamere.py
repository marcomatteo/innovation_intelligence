...
LOG_FILE = "tests/logs/certificazioni/BilanciInfocamere.md"
logging.basicConfig(
...
class Test_CertificazioneBilanciInfocamere(BaseTestCase):
    # Data Provider file name
    dp_file_name = "Infocamere2020.xlsx"
    dp_keys = ['c fiscale', "anno"]
    db_keys = ['CF', 'Anno']
    db_columns = []
    ...
    def setUpClass(cls):
        ...
        super().logInfoTitle(
            "Test Certificazione Data Provider : Bilanci Infocamere {}".format(anno))
        
        super().logInfoMessage("Carico file data provider...")
        try:
            cls.dp = BilanciInfocamere(cls.dp_file_name)
        except:
    ...
    def test_index_comparison_with_utility_function(self):
        ...
        self.logTestTile("Test su ogni bilancio importato")
...
if __name__ == '__main__':
    ...
    suite = loader.loadTestsFromTestCase(Test_CertificazioneBilanciInfocamere)
